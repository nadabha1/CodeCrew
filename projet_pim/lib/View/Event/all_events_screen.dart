...
class AllEventsScreen extends StatefulWidget {
  ...
  const AllEventsScreen({Key? key, required this.userId, required this.token})
      : super(key: key);
...
class _AllEventsScreenState extends State<AllEventsScreen>
  ...
  List<DeviceCalendar.Event> _eventsD = [];
      ...
      if (calendarsResult.isSuccess && calendarsResult.data != null) {
        ...
        if (eventsResult.isSuccess && eventsResult.data != null) {
          setState(() {
            ...
            _freeSlots = _getFreeSlots(_eventsD);
          });

          var formattedEvents = _eventsD.map((event) {
            return {
              'title': event.title,
